...
import FloatOps._
  ...
  test("'SectorMatrix.combine' should add 2 bodies at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 25, 47, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
    ...
    val body2 = new Body(5, 25, 47, 0.1f, 0.1f)
